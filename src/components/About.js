...
const aboutMeDescription = (
  <div className='about-description'>
    <p >Welcome to my website! Built entirely in react.js and designed by myself. My name is Jordan Speed hailing from the great city of Philadelphia.</p>
